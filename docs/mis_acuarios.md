...
- [ ] **A3 (Guardería):** Mantener rutina de alimentación intensiva (3-4 veces al día, _Sera Micron_) y sifonado delicado. Objetivo: Supervivencia > 50% de la camada.
...
- [ ] **Filtro A1:** Monitoreo estricto tras el fallo reciente. Evaluar si requiere cambio de rotor o reemplazo definitivo si vuelve a trabarse.
...
**"Operación Dither Segura":** Llevar a los 6 Barbos Cereza a un tamaño adulto/robusto (>3.5 cm) para evitar depredación o bullying al ser introducidos con la pareja de *Laetacara* en A1.
...
| --- | --- | --- |
| **Barbo Cereza** (*Puntius titteya*) | 6 | **Juveniles (2-3 cm).** Activos y comiendo. |
...
| **Guppy Hembra** | 1 | Adulta. *Alerta:* Posible depredadora (mantener alimentada). |
| **Juv. Guppy/Platy** | Variados | Compañeros de crecimiento. Sin riesgo para alevines. |
| *Invertebrados* | [Variados] | Caracoles (Limpieza de restos de *Sera Micron*). |

### 🧪 Rutina de Guardería

* **Alimentación Intensiva:** 3-4 veces al día.
    * *Menú:* **Sera Micron** (polvo) + Escamas trituradas.
    * *Táctica:* Alimentar primero a la hembra adulta en extremo opuesto.
...
| **12/Ene/26** | **A3** | **¡Nacimientos!** Se confirman ~12 alevines de Platy nadando libres. Se establece rutina de alimentación intensiva (*Sera Micron*). |
...
| **10/Ene/26** | **Gral** | **Ingreso de Fauna:** Compra de 6 Otos, 6 Barbos, 2 Platys, 1 Guppy. Distribución en A2 y A3 según protocolo. |
